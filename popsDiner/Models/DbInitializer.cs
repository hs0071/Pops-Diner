        ...
        public static void Seed(AppDbContext context)
        {
            ...
            if (!context.Items.Any())
            {
                ...
                (
                    ...
                    new Item { Name = "Mango", Price = 12.95M, shortDescription = "You'll love it!", LongDescription = "Lorem Ipsum", Category = Categories["Drinks"], ImageUrl = "https://www.dishesguru.com/uploads/recipe/pineapplemango-main492391798-810.jpg", InStock = true, isItemOfTheWeek = true, ImageThumbnailUrl = "https://www.dishesguru.com/uploads/recipe/pineapplemango-main492391798-810.jpg", AllergyInformation = "" },
                    new Item { Name = "Burger + Fries + Drink", Price = 15.95M, shortDescription = "Our Halloween Favorite!", LongDescription = "Lorem Ipsum", Category = Categories["Combos"], ImageUrl = "https://bv.world/wp-content/uploads/2018/03/FastFood.jpg", InStock = true, isItemOfTheWeek = true, ImageThumbnailUrl = "https://bv.world/wp-content/uploads/2018/03/FastFood.jpg", AllergyInformation = "" },
                    new Item { Name = "Pomegranate", Price = 15.95M, shortDescription = "You'll love it!", LongDescription = "Lorem Ipsum", Category = Categories["Drinks"], ImageUrl = "https://cdn-prod.medicalnewstoday.com/content/images/articles/318/318385/halves-pomegranate-with-seeds-and-pomegranate-juice-on-marbled-surface.jpg", InStock = true, isItemOfTheWeek = false, ImageThumbnailUrl = "https://cdn-prod.medicalnewstoday.com/content/images/articles/318/318385/halves-pomegranate-with-seeds-and-pomegranate-juice-on-marbled-surface.jpg", AllergyInformation = "" },
